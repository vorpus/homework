...
/***/ function(module, exports) {
	...
	View.prototype.exercise3 = function () {
	  ...
	  const $loveWins = $('<h1></h1>');
	  $loveWins.text('i love jquery');
	  // $loveWins.attr('style','background-color:blue');
	  $('div').append($loveWins);
	  //your code here!
	};
	...
	View.prototype.exercise4 = function () {
	  ...
	  let i = 0;
	  let theCells = $('ul').children();
	  theCells.each((cell)=>{
	
	    if (i % 2 === 0) {
	      $(theCells[cell]).attr('style', 'background-color:black');
	    }
	  ...
	  // $('ul li:nth-child(2n+1)').append('Li');
	  //your code here!
	};
	...
	View.prototype.exercise6 = function () {
	  ...
	  $('li').each(function() {
	    randomColor = window._randomColorString();
